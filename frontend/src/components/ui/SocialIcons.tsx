...
export function YoutubeIcon({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7 24.12 24.12 0 0 1 21.5 17a2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17" />
...
// Re-export available icons from lucide-react
export { Facebook, Youtube, X, Instagram as InstagramIconLucide } from 'lucide-react';